...
```
$ docker image tag moneylogger tphucnha/moneylogger
$ docker push tphucnha/moneylogger
$ docker image tag moneyloggergw tphucnha/moneyloggergw
$ docker push tphucnha/moneyloggergw
```
